defmodule TestappWeb.Router do
  ...
  scope "/", TestappWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TestappWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TestappWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TestappWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TestappWeb do
    ...
    live_session :current_user,
      on_mount: [{TestappWeb.UserAuth, :mount_current_user}] do
